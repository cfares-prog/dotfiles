...
hi Macro                         guifg=#FFB8D1   guibg=NONE      gui=bold
...
hi PreProc                       guifg=#d8b65f   guibg=NONE      gui=NONE
...
hi String                        guifg=#5CDB5C   guibg=NONE      gui=NONE
hi Type                          guifg=#C5A3FF   guibg=NONE      gui=NONE
hi Visual                        guifg=NONE      guibg=#3A374D   gui=NONE
" ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┿━━━━━━━━━━━━━━━┿━━━━━━━━━━━━━━━┿━━━━━━━━━━━━━ "
"  c                           │               │               │
hi cFormat                       guifg=#C5A3FF   guibg=NONE      gui=NONE
hi cIncluded                     guifg=#C5A3FF   guibg=NONE      gui=NONE
hi cPreCondit                    guifg=#C5A3FF   guibg=NONE      gui=NONE
hi cSpecial                      guifg=#C5A3FF   guibg=NONE      gui=NONE
" ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┿━━━━━━━━━━━━━━━┿━━━━━━━━━━━━━━━┿━━━━━━━━━━━━━ "
"  git commit                  │               │               │
...
hi diffFile                      guifg=#D8B65F   guibg=NONE      gui=bold
hi diffIndexLine                 guifg=#D8B65F   guibg=NONE      gui=NONE
...
hi diffSubname                   guifg=#9D9AB7   guibg=NONE      gui=bold
" TODO: gitrebase              │               │               │
" ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┿━━━━━━━━━━━━━━━┿━━━━━━━━━━━━━━━┿━━━━━━━━━━━━━ "
"  i3 config                   │               │               │
...
" ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┿━━━━━━━━━━━━━━━┿━━━━━━━━━━━━━━━┿━━━━━━━━━━━━━ "
"  markdown                    │               │               │
hi markdownBlockquote            guifg=#C5A3FF   guibg=NONE      gui=bold
hi markdownBold                  guifg=#F8F8F0   guibg=NONE      gui=bold
hi markdownCode                  guifg=#FFB8D1   guibg=NONE      gui=bold
hi markdownCodeDelimiter         guifg=#FFB8D1   guibg=NONE      gui=bold
...
hi rustAssert                    guifg=#D8B65F   guibg=NONE      gui=bold
hi rustAttribute                 guifg=#FFB8D1   guibg=NONE      gui=bold
hi rustCommentLineDoc            guifg=#9D9AB7   guibg=NONE      gui=NONE
hi rustDerive                    guifg=#FFB8D1   guibg=NONE      gui=bold
hi rustDeriveTrait               guifg=#C5A3FF   guibg=NONE      gui=bold
...
hi rustLifetime                  guifg=#FFB8D1   guibg=NONE      gui=bold
hi rustMacroVariable             guifg=#d8b65f   guibg=NONE      gui=bold
hi rustModPathSep                guifg=#F8F8F0   guibg=NONE      gui=NONE
hi rustPanic                     guifg=#d8b65f   guibg=NONE      gui=bold
hi rustQuestionMark              guifg=#d8b65f   guibg=NONE      gui=bold
hi rustSelf                      guifg=#FFB8D1   guibg=NONE      gui=bold
hi rustSigil                     guifg=#D8B65F   guibg=NONE      gui=NONE
hi rustStringContinuation        guifg=#FFB8D1   guibg=NONE      gui=NONE
" ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┿━━━━━━━━━━━━━━━┿━━━━━━━━━━━━━━━┿━━━━━━━━━━━━━ "
"  shell (zsh)                 │               │               │
...
hi tmuxKey                       guifg=#FFB8D1   guibg=NONE      gui=bold
hi tmuxNumber                    guifg=#FFB8D1   guibg=NONE      gui=bold
hi tmuxOptions                   guifg=#F8F8F0   guibg=NONE      gui=bold
" ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┿━━━━━━━━━━━━━━━┿━━━━━━━━━━━━━━━┿━━━━━━━━━━━━━ "
"  toml                        │               │               │
hi tomlBoolean                   guifg=#F8F8F0   guibg=NONE      gui=bold
hi tomlKey                       guifg=#F8F8F0   guibg=NONE      gui=bold
hi tomlString                    guifg=#F8F8F0   guibg=NONE      gui=NONE
...
hi helpNote                      guifg=#d8b65f   guibg=NONE      gui=bold
...
hi vimOption                     guifg=#FFB8D1   guibg=NONE      gui=bold
" ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┿━━━━━━━━━━━━━━━┿━━━━━━━━━━━━━━━┿━━━━━━━━━━━━━ "
"  vim display misc.           │               │               │
...
hi MatchParen                    guifg=#D8B65F   guibg=NONE      gui=NONE
hi Folded                        guifg=#9D9AB7   guibg=NONE      gui=NONE
hi incSearch                     guifg=#D8B65F   guibg=#3A374D   gui=bold
hi Search                        guifg=#D8B65F   guibg=#3A374D   gui=bold
hi CurSearch                     guifg=#D8B65F   guibg=#3A374D   gui=bold,inverse
" ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┿━━━━━━━━━━━━━━━┿━━━━━━━━━━━━━━━┿━━━━━━━━━━━━━ "
"  vim cursor                  │               │               │
...
" ┍━━━━━━━━━━━━━━━━━━━━━━━━━━━━┯━━━━━━━━━━━━━━━┯━━━━━━━━━━━━━━━┯━━━━━━━━━━━━┑ "
"  coc.nvim theme              │               │               │
hi CocSearch                     guifg=#D8B65F   guibg=NONE      gui=bold
hi CocUnusedHighlight            guifg=NONE      guibg=NONE      gui=NONE
hi CocNotificationProgress	     guifg=#D8B65F   guibg=NONE      gui=bold
...
" ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┿━━━━━━━━━━━━━━━┿━━━━━━━━━━━━━━━┿━━━━━━━━━━━━━ "
"  vim message window          │               │               │
hi NvimTreeOpenedFolderName      guifg=#C5A3FF   guibg=NONE      gui=bold
" ┕━━━━━━━━━━━━━━━━━━━━━━━━━━━━┷━━━━━━━━━━━━━━━┷━━━━━━━━━━━━━━━┷━━━━━━━━━━━━┙ "
